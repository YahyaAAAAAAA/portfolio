...
class GridMouseTrail extends StatefulWidget {
  ...
  const GridMouseTrail({
    super.key,
    required this.child,
    this.trailColor = const Color.fromARGB(255, 122, 92, 158),
    this.cellSize = 15,
  ...
  @override
  _GridMouseTrailState createState() => _GridMouseTrailState();
}
...
class GridTrailPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size canvasSize) {
    ...
    for (var neighbor in allNeighbors) {
      ...
      final neighborPaint =
          Paint()
            ..color = trailColor.withOpacity(neighbor.opacity / 255.0)
            ..style = PaintingStyle.stroke
            ..strokeWidth = 0.8;
